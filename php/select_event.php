    ...
    <div class="content">
        <div class="container">
            ...
            <form method="post">
                ...
                <input type="number" step="0.01" name="vip_price" id="vip_price" placeholder="VIP Ticket Price" required>

                <label for="regular_price">Regular Ticket Price:</label>
                <input type="number" step="0.01" name="regular_price" id="regular_price" placeholder="Regular Ticket Price" required>

                <label for="economy_price">Economy Ticket Price:</label>
                <input type="number" step="0.01" name="economy_price" id="economy_price" placeholder="Economy Ticket Price" required>
                ...
                <input type="number" step="0.01" min="0" max="100" name="promo_discount" id="promo_discount" placeholder="e.g. 15">
